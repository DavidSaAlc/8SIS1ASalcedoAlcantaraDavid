...
function Des(event, el){//Validar nombre	
...
function interes(){
    var valor = document.formulario.sub.value;
    var resul = parseInt(valor);
    var total = (resul)*(0.85);

    document.formulario.descuentoI.value = "$" + total;
}

function eliminar(){
    document.formulario.sub.value = "";
    document.formulario.descuentoI.value = "";
}